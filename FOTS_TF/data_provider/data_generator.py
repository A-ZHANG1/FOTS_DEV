...
def get_training_data():
    ...
    gt_list = []
    img_paths = [
        "/home/ist/Desktop/OCR_exp/OCR_dataset/SROIE2019/task1train/",
        "/home/ist/Desktop/OCR_exp/OCR_dataset/ICDAR_2015/train_img",
        "/home/ist/Desktop/OCR_exp/OCR_dataset/funsdata/training_data/images"
    ]

    gt_paths = [
        "/home/ist/Desktop/OCR_exp/OCR_dataset/SROIE2019/task1train/",
        "/home/ist/Desktop/OCR_exp/OCR_dataset/ICDAR_2015/train_gt",
        "/home/ist/Desktop/OCR_exp/OCR_dataset/funsdata/training_data/wordtxts"
    ]

    for img_path in img_paths:
        img_list += [os.path.join(img_path, img_file) for img_file in sorted(os.listdir(img_path)) if
                     valid_file(img_file, "pic")]
    for gt_path in gt_paths:
        gt_list += [os.path.join(gt_path, gt_file) for gt_file in sorted(os.listdir(gt_path)) if
                    valid_file(gt_file, "txt")]
    image_list = np.array(img_list)
    return image_list, gt_list

def valid_file(filename,filetype):
    if filetype == "txt":
...
def generator(input_images_dir, input_gt_dir, input_size=512, batch_size=12, random_scale=np.array([0.8, 0.85, 0.9, 0.95, 1.0, 1.1, 1.2]),):
    ...
    image_list, gt_list = get_training_data()
